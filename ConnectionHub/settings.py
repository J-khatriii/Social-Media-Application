...
DATABASES = {
    'default': {
        ...
        'NAME': env('DATABASE_NAME',default="connectionhub"),
        'USER': env('DATABASE_USERNAME',default='user'),
        'PASSWORD': env('DATABASE_PASSWORD',default='iknow@123'),
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = env('EMAIL_ADDRESS',default='jaswant@example.com')
EMAIL_HOST_PASSWORD = env('EMAIL_PASSWORD',default='iam12345')
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',default='jaswant@exmaple.com')
...
cipher_suite = Fernet(env('FERNET_KEY',default='myiYN0YO1F5FLK34Mcjrae8RMFBL2e5IyKr2fKvBVRk='))
